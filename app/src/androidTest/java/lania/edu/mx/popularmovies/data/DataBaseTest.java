...
public class DataBaseTest extends AndroidTestCase {
    ...
    public void testCreateDataBase() throws Throwable {
        ...
        assertTrue("An exception has occurred opening the database " + PopularMoviesDbHelper.DATABASE_NAME, sqliteDatabase.isOpen());
    ...
    public void testMovieTable() {
        ...
        Cursor movieCursor = database.query(PopularMoviesContract.MovieEntry.TABLE_NAME, null, null, null, null, null, null);
